...
TOY = {
    ...
    '_adj': ['short', 'quick', 'busy', 'nice', 'gorgeous', 'spectacular', 'reluctant', 'systematic', 'willowy',
             'engaged', 'synthetic']
}
...
def load_imdb_synth(ntrain=25_000, ntest=25_000, seed=0):
    ...
    adjectives = ['classic', 'silent', 'modern', 'vintage', 'independent', 'foreign', 'animated',
                  'epic', 'dramatic', 'romantic', 'comic', 'thrilling', 'mysterious', 'gritty', 'stylized', 'iconic',
                  'acclaimed',
                  'popular', 'forgettable', 'unreleased', 'awardwinning', 'blockbuster', 'lowbudget', 'highbudget',
                  'experimental',
                  'mainstream', 'cult', 'notable', 'original']
    nouns = ['movie', 'film', 'motion-picture', 'feature', 'featurette', 'picture', 'flick', 'cinema', 'screenplay',
             'talkie', 'biopic', 'short', 'docudrama', 'documentary', 'animation', 'cartoon',
